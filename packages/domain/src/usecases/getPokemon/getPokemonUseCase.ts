...
export class GetPokemonUseCase
  extends UseCase<InputGetPokemonValues, OutputGetPokemonValues>
  implements IGetPokemonEntryPointBoundary
{
  ...
  override async execute(
    inputPokemonValues: InputGetPokemonValues,
  ): Promise<OutputGetPokemonValues> {
    return this.pokemonRepository
      .getPokemon(inputPokemonValues.pokemonId)
      .then((pokemon: Pokemon) =>
        Builder<OutputGetPokemonValues>().pokemon(pokemon).build(),
      );
  }
}
