  ...
  const appRoutes: AppProps[] = [
    {
      path: `/`,
      element: (
        <PageTitleWrapper title={routesName.pokemon.children.list.title}>
          <PokemonList />
        </PageTitleWrapper>
      ),
    },
    ...
    },
    {
      ...
      element: (
        <PageTitleWrapper title={routesName.pokemon.children.detail.title}>
          <PokemonsDetail />
        </PageTitleWrapper>
      ),
    },
    {
      ...
      element: (
        <PageTitleWrapper title={routesName.pokemon.children.editing.title}>
          <PokemonEdit />
        </PageTitleWrapper>
      ),
    },
    {
      ...
      element: (
        <PageTitleWrapper title={routesName.pokemon.children.add.title}>
          <PokemonAdd />
        </PageTitleWrapper>
      ),
    },
