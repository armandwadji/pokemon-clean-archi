...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    /************** POKÉMONS DATA PROVIDERS **************/
    {
      ...
      useFactory: () =>
        new PokemonDataProviderFactory(
          inject(Init).getConfig().pokemonDataProviderVersion,
        ),
    },
    ...
    /************** GET POKÉMONS **************/
    {
      ...
      useFactory: (
        pokemonRepository: IPokemonDataProviderBoundary,
    ...
    },
    {
      ...
      ): GetPokemonsController => new GetPokemonsController(getPokemonsUseCase),
    ...
    /************** GET POKÉMON **************/
    {
      ...
      useFactory: (
        pokemonRepository: IPokemonDataProviderBoundary,
      ): GetPokemonUseCase => new GetPokemonUseCase(pokemonRepository),
      deps: [IPokemonDataProviderToken],
    },
    {
      provide: GetPokemonController,
      useFactory: (
        getPokemonsUseCase: GetPokemonUseCase,
      ): GetPokemonController => new GetPokemonController(getPokemonsUseCase),
    ...
    /************** POST POKÉMONS **************/
    {
      ...
      useFactory: (
        pokemonRepository: IPokemonDataProviderBoundary,
      ): AddPokemonUseCase => new AddPokemonUseCase(pokemonRepository),
      deps: [IPokemonDataProviderToken],
    },
    {
      provide: AddedPokemonController,
      useFactory: (
        addPokemonUseCase: AddPokemonUseCase,
      ): AddedPokemonController =>
    ...
    /************** UPDATE POKÉMONS **************/
    {
      ...
      useFactory: (
        pokemonRepository: IPokemonDataProviderBoundary,
      ): UpdatePokemonUseCase => new UpdatePokemonUseCase(pokemonRepository),
      deps: [IPokemonDataProviderToken],
    },
    {
      provide: EditPokemonController,
      useFactory: (
        editPokemonUseCase: UpdatePokemonUseCase,
      ): EditPokemonController => new EditPokemonController(editPokemonUseCase),
    ...
    /************** DELETE POKÉMONS **************/
    {
      ...
      useFactory: (
        pokemonRepository: IPokemonDataProviderBoundary,
      ): DeletePokemonUseCase => new DeletePokemonUseCase(pokemonRepository),
      deps: [IPokemonDataProviderToken],
    },
    {
      provide: DeletePokemonController,
      useFactory: (
        editPokemonUseCase: DeletePokemonUseCase,
      ): DeletePokemonController =>
        new DeletePokemonController(editPokemonUseCase),
